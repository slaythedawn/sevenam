...
const PAGES = [
...

  {
    ...
    systemMap: {
      label: 'HOW IT WORKS',
      h2: 'A system that remembers what works.',
      p: 'Most AI marketing is an agent guessing. This is an agent reading from a memory your business owns \u2014 and a person approving whatever leaves.',
      columns: [
        {
          label: 'IN',
          title: 'Signal',
        ...
        },
        {
          ...
          title: 'Memory',
          rows: ['The language that wins', 'The objections that recur', 'Corrections, so mistakes happen once'],
        },
        {
          label: 'OUT',
          title: 'Work',
      ...
      gate: {
        ...
        text: 'Nothing that spends money, emails a customer or changes a record leaves without a person agreeing to it.',
      },
      note: 'Drawn from our own design tokens rather than a wall of vendor logos: the tools underneath a build differ for every client, and the repository and the job specs are the system.',
    },
